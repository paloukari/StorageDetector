...
namespace SystemTrayApp
{
    ...
    public delegate void StorageDetectorEventHandler(Object sender, StorageDetectorEventArgs e);
    ...
    public class StorageDetector
    {
        ...
        /// </summary>
        public event StorageDetectorEventHandler StorageDetected;

        /// <summary>
        /// The easiest way to use StorageDetector. 
        ...
        /// Pass in your Form and StorageDetector will not create hidden form.
        /// </summary>
        /// <param name="control">object which will receive Windows messages. 
        /// Pass "this" as this argument from your form class.</param>
        public StorageDetector(Control control)
        {
            Init(control, null);
        }

        /// <summary>
        /// Consructs StorageDetector object setting also path to file which should be opened
        ...
        public StorageDetector(Control control, string FileToOpen)
        {
            Init(control, FileToOpen);
        }

        /// <summary>
        /// init the StorageDetector object
        /// </summary>
        ...
        /// about it's removal. 
        /// This will be null unless you specified a file to open (StorageDetector opens root directory of the flash drive) 
        /// </summary>
        ...
        /// By default StorageDetector will open the root directory of the flash drive to obtain notification handle
                ...
                switch (m.WParam.ToInt32())
                {
                    ...
                    case DBT_DEVICEARRIVAL:
                        ...
                        if (devType == DBT_DEVTYP_VOLUME)
                        {
                            ...
                            StorageDetectorEventHandler tempDeviceArrived = StorageDetected;
                            if (tempDeviceArrived != null)
                            {
                                StorageDetectorEventArgs e = new StorageDetectorEventArgs();
                                e.Drive = c + ":\\";
